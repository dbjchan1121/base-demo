...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: H_e-dLIFbCQ/css
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option___6Z2UW)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option___9CwJw)}
              />
            </React.Fragment>
          ),
          value: args.children
