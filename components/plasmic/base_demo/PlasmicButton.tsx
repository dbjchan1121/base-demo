...
import sty from "./PlasmicButton.module.css"; // plasmic-import: YKQQzz1RwZn/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: pCL6omxJijZ/icon
import Icon3Icon from "./icons/PlasmicIcon__Icon3"; // plasmic-import: ZQ1dqBXcRba/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__i4Nax)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon3Icon
                className={classNames(projectcss.all, sty.svg__e3J6H)}
                role={"img"}
              />
            ),
