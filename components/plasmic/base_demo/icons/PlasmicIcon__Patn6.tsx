...
export type Patn6IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Patn6Icon(props: Patn6IconProps) {
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            in2={"shape"}
            result={"effect1_innerShadow_7144_272835"}
          ></feBlend>
        </filter>
      </defs>
    </svg>
