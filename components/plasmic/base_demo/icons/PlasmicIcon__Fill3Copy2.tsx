...
export type Fill3Copy2IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Fill3Copy2Icon(props: Fill3Copy2IconProps) {
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            in2={"shape"}
            result={"effect1_innerShadow_7116_217899"}
          ></feBlend>
        </filter>
      </defs>
    </svg>
